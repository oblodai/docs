...
```python Python
call("/v1/payment", {"amount": "100", "currency": "EUR", "order_id": "order-1",
...
```js Node.js
await call("/v1/payment", { amount: "100", currency: "EUR", order_id: "order-1",
                            to_currency: "USDT", network: "tron" });
// → 100.00 EUR ≈ 108.695653 USDT
...
```python Python
call("/v1/payment", {"amount": "5000", "currency": "KZT", ...})
# → 400 payment.unknown_currency
```
