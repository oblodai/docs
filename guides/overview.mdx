...
<CardGroup cols={2}>
  ...
  <Card title="Массовые выплаты: батч vs легаси /mass" icon="people-group" href="/guides/mass-payouts">
...
<CardGroup cols={2}>
  ...
  <Card title="Что делать, если не работает" icon="wrench" href="/guides/troubleshooting">
