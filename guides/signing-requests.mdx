...
description: "Подпись HMAC-SHA256 и три заголовка: основа безопасности и источник большинства ошибок на старте."
icon: "signature"
---
