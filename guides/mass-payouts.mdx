...
<Info>
  **Ещё не в проде.** `/v1/payout/batch` станет доступен после деплоя обновлённого шлюза
  (одновременно с выходом SDK v1.1.0). До этого используйте текущий `/v1/payout/mass`.
