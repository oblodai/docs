...
|---|---|---|---|
| `currency_from` | string | нет | Код валюты. Если задан — вернётся курс только по нему. Если пусто или тело `{}` — по всем валютам. |
...
| Поле | Тип | Описание |
|---|---|---|
| `from` | string | Валюта, для которой дана котировка. |
| `to` | string | Всегда `USDT`. |
| `course` | string | Курс строкой с фиксированной точностью. |
