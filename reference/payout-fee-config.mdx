---
title: "POST /v1/payout/fee-config/get · /set"
---
...
|---|---|---|---|
| `fee_on_recipient` | bool | да | `true` — сетевую комиссию платит получатель (получает меньше); `false` — комиссию несёт мерчант. |
...
- [`POST /v1/payout/calculate`](/reference/payout-calculate) · [`POST /v1/payout`](/reference/payout-create)
