...
<ResponseField name="currencies[].decimals" type="int64">
  Число знаков после запятой у актива.
</ResponseField>

<ResponseField name="currencies[].networks" type="array<object>">
  Сети, на которых доступен актив.

  <Expandable title="поля networks[]">
    ...
    <ResponseField name="min_confirmations" type="int64">
    ...
    <ResponseField name="deposit_available" type="bool">
      Доступен ли приём платежей в этой сети прямо сейчас.
    </ResponseField>
    <ResponseField name="payout_available" type="bool">
...
<ResponseField name="pricing_currencies[].decimals" type="int64">
