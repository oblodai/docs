...
- [Аутентификация](/reference/basics-auth) — справочная версия.
- [Идемпотентность](/reference/basics-idempotency) · [IP‑allowlist](/reference/api-allowlist)
- [Объект вебхука](/reference/webhook-object) — другой алгоритм подписи.
