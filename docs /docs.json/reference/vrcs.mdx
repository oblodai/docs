...
|---|---|---|---|
| `enabled` | bool | нет | Включить/выключить VRCS. **Опустите поле для чтения** текущего состояния. |
...
- [`POST /v1/balance`](/reference/balance) · [Форматы сумм и денег](/reference/basics-money)
